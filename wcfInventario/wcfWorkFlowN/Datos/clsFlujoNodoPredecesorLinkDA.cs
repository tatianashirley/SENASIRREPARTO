...
namespace wcfWorkFlowN.Datos {
    ...
    public class clsFlujoNodoPredecesorLinkDA : clsWorkflowBaseDA {
        ...
        /// <summary>
        /// Registra un enlace como requerido para la transición
        /// </summary>
        /// <returns></returns>
        public bool Adicion() {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_FlujoNodoPredecesorLink", "I");
        ...
        /// <summary>
        /// Elimina un enlace requerido para la transición
        /// </summary>
        /// <returns></returns>
        public bool Eliminacion() {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_FlujoNodoPredecesorLink", "D");
            if (!ObjSPExec.p_bEstadoOK) {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            } else {
                bool bAsignacionOK = true;
       ...
       public bool ObtieneFila() {
           ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_FlujoNodoPredecesorLink", "V");
            if (!ObjSPExec.p_bEstadoOK) {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            } else {
                bool bAsignacionOK = true;
        ...
        /// <summary>
        /// Obtiene los links requeridos para la transición
        /// </summary>
        /// <retur1ns></returns>
        public bool ObtieneEnlacesXTransicion() {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_FlujoNodoPredecesorLink", "Q");
            if (!ObjSPExec.p_bEstadoOK) {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            } else {
                bool bAsignacionOK = true;
