...
namespace wcfWorkFlowN.Datos {
    ...
    public class clsTipoTramiteDA : clsWorkflowBaseDA {
        ...
        public bool ObtieneFila() {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_TipoTramite", "V");
            if (!ObjSPExec.p_bEstadoOK) {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            } else {
                bool bAsignacionOK = true;
        ...
        public bool ObtieneTiposDeTramite() {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_TipoTramite", "Q");
            if (!ObjSPExec.p_bEstadoOK) {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            } else {
                bool bAsignacionOK = true;
