...
public partial class Reportes_wfrmReporteCertificacionSalariosCorrelativo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                rptCertificacionSalarios.ServerReport.ReportPath = "/CertificacionCC/rptReporteCertificacionSalariosCorrelativo";
