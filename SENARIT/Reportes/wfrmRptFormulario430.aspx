<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmRptFormulario430.aspx.cs" Inherits="Reportes_wfrmRptFormulario430" %>
...
<div style="vertical-align: top; left: auto; height: auto; overflow: auto; width: 1200px;">
    <asp:Label ID="Label1" runat="server" Text="REPORTE FORMULARIO 430" CssClass="etiqueta20" ></asp:Label>
