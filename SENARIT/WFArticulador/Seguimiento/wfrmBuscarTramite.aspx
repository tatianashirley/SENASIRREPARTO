<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmBuscarTramite.aspx.cs" Inherits="Seguimiento_wfrmBuscarTramite" %>
                ...
                <td align="center">
                    <asp:GridView ID="gvBusquedaTramiteCC" runat="server" EnableModelValidation="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TipoTramite" HeaderText="Tipo Trámite" Visible="false" />
                            <asp:BoundField DataField="tipoRelacion" HeaderText="Relación" />
                            ...
                            <asp:BoundField DataField="ComplementoSEGIP" HeaderText="Complemento SEGIP" ItemStyle-Width="8px" ItemStyle-HorizontalAlign="Right" Visible="false" />
                            ...
                            <asp:BoundField DataField="DescripcionEstadoObjeto" HeaderText="Estado del Trámite"/>
