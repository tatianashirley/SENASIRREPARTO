...
public partial class Reprocesos_wfrmRptFormularioReprocesoRM266svr : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                repParams[1] = new ReportParameter("o_iNroFormularioRepro", NroFormularioRepro.ToString());
                ...
                ReportViewer1.ServerReport.ReportPath = "/ReportesEnviosAPS/rptFormularioReprocesoRM266";
