<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmConsultaDeTramites.aspx.cs" Inherits="Reprocesos_wfrmConsultaDeTramites" %>
...
<cc1:CalendarExtender ID="CalendarExtender3" runat="server" PopupButtonID="ImageButton1" TargetControlID="TextBox1" ></cc1:CalendarExtender>
    ...
    <asp:Panel ID="pnlRM266" runat="server">
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="panelceleste">
        <tr>
            <td width="1%">&nbsp;</td>
            <td width="15%" align="right">
            ...
            <td width="20%">
                <asp:Label ID="Label8" runat="server" Text="RM266 Cambio de Fecha de Nacimiento" CssClass="etiqueta10" Font-Bold="True"></asp:Label>
            </td>
            <td width="1%">&nbsp;</td>
            <td width="45%">
