...
public partial class Reprocesos_wfrmBuscadorDeTramites : System.Web.UI.Page
{
    ...
    private Boolean vTramiteEnBandejaTrabajo
    {
    ...
    protected void gvDatosAfiliado_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "DETALLE01")
        {
            ...
            lblMsgTramiteNoEnBandejaTrabajo.Visible = false;
    ...
    protected void chkCertificado_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (chkCertificado.Checked == true)
        {
            ...
            vTramiteEnBandejaTrabajo = objDatosAfiliado.ValidaTramiteEnBandejaTrabajo(IdConexion, vIdTramite, vIdGrupoBeneficio);

            if (vTramiteEnBandejaTrabajo)
            {
                if (!chkRegistroAPS.Checked && !chkCursoPago.Checked && vIdEstadoObjetoProceso == 32 && EstadoCertificado == "34")
                {
                    ddlTipoReproceso.Items.Add(new ListItem("R.M.266", "R"));
                    ddlTipoReproceso.Items.Add(new ListItem("RENUMERACIONES", "N"));
                }
                if (!chkRegistroAPS.Checked && !chkCursoPago.Checked && vIdEstadoObjetoProceso == 32 && EstadoCertificado == "37")
                {
                    ddlTipoReproceso.Items.Add(new ListItem("RENUMERACIONES", "N"));
                }
            ...
            {
                if (!chkRegistroAPS.Checked && !chkCursoPago.Checked 
                    && (vIdEstadoObjetoProceso == 32 || vIdEstadoObjetoProceso == 13) 
                    && (EstadoCertificado == "34" || EstadoCertificado == "37"))
                {
                    ddlTipoReproceso.Items.Add(new ListItem("RENUMERACIONES", "N"));
                }
            }
            if (ddlTipoReproceso.Items.Count == 1 && ddlTipoReproceso.SelectedValue == "X")
            {
                //Borra opciones correspondientes al tramite
                lblTipoReproceso.Visible = false;
                ddlTipoReproceso.Visible = false;
                ddlTipoReproceso.Items.Clear();
                lblMsgTramiteNoEnBandejaTrabajo.Visible = true;
            }
        }
        ...
        //if (!vTramiteEnBandejaTrabajo && chkCertificado.Checked == true)
        //{
        //    //ddlTipoReproceso.Items.Clear();
        //    //ddlTipoReproceso.Visible = false;
        //    //lblTipoReproceso.Visible = false;
    ...
    protected void gvCertificados_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if ((vIdEstadoObjetoProceso == 32 || EstadoCertificado == "37") && vRegistroActivo) //Certificado Baja - Habilitado a Renumeraciones
            {
                chkCertificado.Visible = true;
            }
