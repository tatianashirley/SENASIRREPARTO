<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmRM266Certificado.aspx.cs" Inherits="Reprocesos_wfrmRM266Certificado" %>
...
<tr>
    <td align="center">
        ...
        <asp:Label ID="lblTituloAUX" runat="server" Text="RM266 - Procesa e Imprime Certificados" CssClass="etiqueta20"> </asp:Label>
    </td>
</tr>
</table>
<table style="width: 100%;" cellpadding="0" cellspacing="0" class="panelceleste">
    <tr>
        ...
        <td width="98%" align="left">
            <asp:Label ID="Label5" runat="server" Text="Certificado a Reprocesarse" CssClass="etiqueta10" Font-Bold="True"></asp:Label>
        </td>
        <td width="1%"></td>
    </tr>
    <tr>
...
<table style="width: 100%;" cellpadding="0" cellspacing="0" class="panelceleste">
    <tr>
        <td width="1%"></td>
        <td width="98%" align="left">
            <asp:Label ID="Label3" runat="server" Text="Asignación de Certificados" CssClass="etiqueta10" Font-Bold="True"></asp:Label>
        </td>
        <td width="1%"></td>
    </tr>
    <tr>
            ...
            <div style="vertical-align: top; left: auto; height: auto; overflow: auto; width: 1200px;" class="panelceleste">
                <asp:GridView ID="gvAsignacionCertificados" runat="server"
                    ...
                    <EmptyDataTemplate><div align="center" class="CajaDialogoAdvertencia">
                        ...
                        <br/>No existen Certificados disponibles para el Area:
                        <br/><br/>
                        </div>
                    </EmptyDataTemplate>
                </asp:GridView>
    ...
    <tr>
        ...
        <td width="98%" align="left">
            <table cellpadding="0" cellspacing="0" class="panelceleste">
                ...
                <tr>
                    <td align="right">
						<asp:ImageButton ID="imgProcesaCertificado" runat="server"  ImageUrl="~/Imagenes/32imprimir.png" ToolTip="Procesa e Imprime Certificado" OnClick="imgProcesaCertificado_Click"   /> 
						<asp:Label ID="Label10" CssClass="etiqueta8Blue" runat="server" Text="Procesa e Imprime Certificado" /> 
                    </td>
                </tr>
            </table>                                
        </td>
