...
public partial class WorkFlow_wfrmGrupoRestricciones : System.Web.UI.Page
{
    private clsGrupoRestriccion objInstanciaGrupoRest = new clsGrupoRestriccion();
    private clsGrupoRestriccionDet objInstanciaGrupoRestDet = new clsGrupoRestriccionDet();
    ...
    private void CargarGrillaGrupoRestriccion()
    {
        ...
        {            
            ...
            if(objInstanciaGrupoRest.iNivelError == 1)
    ...
    {
        var objInstRestricciones = new clsRestriccion();

        objInstRestricciones.iIdConexion = _idConexion;
        if (objInstRestricciones.ObtieneRestricciones())
        {
            cboRestriccion.DataSource = objInstRestricciones.DSet.Tables[0];
            cboRestriccion.DataTextField = "IdRestriccionDesc";
    ...
    private void CargarGrillaGrupoRestricDet()
    {
        ...
        if (dataKey != null)
            objInstanciaGrupoRestDet.iIdGrupoRestriccion = Convert.ToInt32(dataKey.Value);
        ...
        else
        {
            ...
            if(objInstanciaGrupoRestDet.iNivelError == 1)
    ...
    private void CargarCamposDetalle(int pIdGrupoRestricion)
    {
        objInstanciaGrupoRestDet.iIdConexion = _idConexion;
    ...
    {        
        ...
        if (objInstanciaGrupoRestDet.ObtieneFila())
        {
            CargarCamposDetalle(objInstanciaGrupoRestDet.iIdGrupoRestriccion);
