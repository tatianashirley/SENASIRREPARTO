...
public partial class WorkFlow_wfrmTipoTramite : System.Web.UI.Page
{
    private clsTipoTramite ObjInstanciaTipoTram = new clsTipoTramite();
    ...
    private void CargarGrillaTipoTramites()
    {
        ...
        else
        {
            ...
            if(ObjInstanciaTipoTram.iNivelError == 1)
    ...
    protected void gvTipoTramites_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ObjInstanciaTipoTram.iIdConexion = _idConexion;
        ObjInstanciaTipoTram.sIdTipoTramite = gvTipoTramites.DataKeys[rowSelect].Value.ToString();
