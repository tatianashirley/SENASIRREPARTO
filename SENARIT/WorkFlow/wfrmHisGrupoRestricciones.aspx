<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmHisGrupoRestricciones.aspx.cs" Inherits="WorkFlow_wfrmHisGrupoRestricciones"  StylesheetTheme="Modal"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <asp:Panel ID="pnlMaestro" runat="server">
            <table style="width: 100%;">
                ...
                <asp:Label ID="lblTituloAUX" runat="server"
                    Text="REGISTRO GRUPO DE RESTRICCIONES" CssClass="etiqueta20"></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center" colspan="4" class="filaBtn">
                        ...
                        <asp:HiddenField ID="hdfHisInstancia2" runat="server" />
                ...
                <tr>
                    <td align="center" colspan="4">
                        <asp:GridView ID="gvGrupRestric" runat="server" DataKeyNames="IdGrupoRestriccion,IdHisInstancia" OnSelectedIndexChanged="gvGrupRestric_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="gvGrupRestric_PageIndexChanging">
                            <Columns>
    ...
    <div>
         <asp:Panel ID="pnlDetalle" runat="server" Visible="False" CssClass="panelceleste">
             <table style="width: 100%;">
                <tr>
                    <td align="center" colspan="7">
                        <asp:ImageButton ID="imgAux0" runat="server" ImageUrl="~/Imagenes/16w.png" />
                        <asp:Label ID="lblTituloAUX0" runat="server" CssClass="etiqueta20" Text="REGISTRO DETALLE GRUPO DE RESTRICCIONES"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 150px">
                ...
                <tr>
                    ...
                    <td align="left" style="width: 280px">
                        <asp:TextBox ID="txtSubGrupo" runat="server" CssClass="box"></asp:TextBox>
