<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmHisRestricciones.aspx.cs" Inherits="WorkFlow_wfrmHisRestricciones" StylesheetTheme="Modal"%>
    ...
    <div>
      <asp:Panel ID="pnlDatos" runat="server">
        <table style="width: 100%;">
            <tr>
                <td colspan="4" class="filaTit">
                    <asp:ImageButton ID="imgAux" runat="server" ImageUrl="~/Imagenes/16w.png" />
                    <asp:Label ID="lblTituloAUX" runat="server" CssClass="etiqueta20" Text="REGISTRO RESTRICCIONES"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" colspan="4">
                    <asp:GridView ID="gvRestricciones" runat="server" OnSelectedIndexChanged="gvRestricciones_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="gvRestricciones_PageIndexChanging" AutoGenerateColumns="False" DataKeyNames="IdRestriccion,IdHisInstancia">
                        <Columns>
