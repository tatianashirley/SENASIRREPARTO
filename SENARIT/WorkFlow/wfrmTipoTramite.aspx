<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmTipoTramite.aspx.cs" Inherits="WorkFlow_wfrmTipoTramite" StylesheetTheme="Modal"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="pnlGral">
        <asp:Panel ID="pnlTipoTram" runat="server" CssClass="pnlBody">
            <table style="width: 100%;">
                <tr>
                    <td colspan="6" align="center">
                        <asp:ImageButton ID="imgAux" runat="server" ImageUrl="~/Imagenes/16w.png" />
                        <asp:Label ID="lblTituloAUX" runat="server" CssClass="texto12" Text="Registro Tipo Trámite"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td align="left" width="240">
                        <asp:TextBox ID="txtMaxDiasIniTram" runat="server" Width="100px"></asp:TextBox>
                    ...
                    <td align="left" width="240">
                        <asp:TextBox ID="txtMaxDiasInactivo" runat="server" Width="100px"></asp:TextBox>
                ...
                <tr>
                    <td align="center" colspan="6">
                        <asp:GridView ID="gvTipoTramites" runat="server" OnSelectedIndexChanged="gvTipoTramites_SelectedIndexChanged" BorderColor="#DADADA" AllowPaging="True" DataKeyNames="IdTipoTramite" OnPageIndexChanging="gvTipoTramites_PageIndexChanging">
        ...
        <asp:Panel ID="pnlLinks" runat="server" CssClass="pnlPest">
            <table style="width: 100%;">
                <tr>
