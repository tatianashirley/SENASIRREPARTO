...
public partial class WorkFlow_wfrmRestricciones : System.Web.UI.Page
{
    private clsRestriccion objInstanciaRestric = new clsRestriccion();
    private clsConcepto objInstanciaConcepto = new clsConcepto();
    int _idConexion;
    ...
    private void CargarGrillaRestricciones() 
    {
        ...
        if (objInstanciaRestric.ObtieneRestricciones())
        {
        ...
        else
        {
            ...
            if(objInstanciaRestric.iNivelError == 1)
