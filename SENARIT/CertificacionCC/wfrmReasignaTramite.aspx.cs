...
public partial class Seguridad_wfrmUsuario : System.Web.UI.Page
{
   ...
   //wcfNovedades.Datos.clsNovedadesDA obj = new wcfNovedades.Datos.clsNovedadesDA();
    ...
    private void Cargar_Grid()
    {
        ...
        gvDatos.DataSource = ObjTramite.ListarTramitesReasigna(iIdConexion, cOperacion_AT, sSessionTrabajo, sSNN, FechaInicio, FechaFin, clasinicio, clasfin, numregistros,
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        int IdRolUsuarioAsignado = Convert.ToInt32(ddlUsuariosCC.SelectedValue);
        ...
        foreach (GridViewRow row in gvDatos.Rows)
        {
            if (row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (chkTramite.Checked)
                {
                    ...
                    if (ObjTramite.ReAsignaTramite(iIdConexion, IdTramiteAsignado, IdRolUsuarioAsignado, sObservaciones, ref sMensajeError))
                    {
    ...
    protected void rblTipoAsignacion_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string cOperacion = rblTipoAsignacion.SelectedValue.ToString();
        string TipoUsuario = "1";
        if (cOperacion == "R") TipoUsuario = "0";
        if (cOperacion == "E") TipoUsuario = "1";
        if (cOperacion == "C") TipoUsuario = "2";
