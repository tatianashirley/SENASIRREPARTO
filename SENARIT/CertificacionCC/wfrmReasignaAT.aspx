<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmReasignaAT.aspx.cs" Inherits="Seguridad_wfrmUsuario" StylesheetTheme="Modal" %>
        ...
        <div>
            ...
            <table align="center" cellpadding="0" cellspacing="0">
                    ...
                    <td align="left" style="width:20%" valign="middle">
                        <asp:Label ID="Label11" runat="server" CssClass="etiqueta10" Style="text-align: left" Text="CUA: "></asp:Label>
