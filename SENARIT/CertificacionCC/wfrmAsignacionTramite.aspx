<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmAsignacionTramite.aspx.cs" Inherits="Seguridad_wfrmUsuario" StylesheetTheme="Modal" %>
    ...
    <asp:Panel ID="Panel1" runat="server">
        <div>
            ...
            <table align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left" style="width:18%" valign="middle">&nbsp;</td>
                        <td align="right" style="width:15%" valign="middle">Asignación:</td>
                        <td align="left" style="width:20%" valign="middle">
                            <asp:RadioButtonList ID="rblTipoAsignacion" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblTipoAsignacion_SelectedIndexChanged" >
                                <asp:ListItem Value="0">Grupo de Trabajo</asp:ListItem>
                                <asp:ListItem Value="1">Personalizada</asp:ListItem>
                            </asp:RadioButtonList>
                            
                            <asp:Label ID="Label1" runat="server" CssClass="etiqueta10" Style="text-align: left" Text="Nro: " Visible="False"></asp:Label>
                            <asp:TextBox ID="TxtNro" runat="server" MaxLength="15" Width="100px" Visible="False" >0</asp:TextBox>
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="txtNro" />
                    ...
                    <tr>
                        ...
                        <td align="left" style="width:15%" valign="middle">&nbsp;</td>
                        <td align="left" style="width:20%" valign="middle">
                            <asp:DropDownList ID="ddlListaUsuarios" runat="server" AppendDataBoundItems="true" >
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddlListaEquipos" runat="server" AppendDataBoundItems="true" >                               
                            </asp:DropDownList>
                        <td align="center">&nbsp;</td>
                    </tr>
					<tr>
                    ...
                    <tr>
                        <td align="center" colspan="5">
                            <asp:GridView ID="gvDatos" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="#DADADA" BorderStyle="Solid" BorderWidth="1px" CssClass="mGrid" DataKeyNames="IdTramiteClasificado" EnableTheming="True" Font-Names="Arial" Font-Size="9pt" GridLines="Horizontal" OnPageIndexChanging="gvDatos_PageIndexChanging" OnRowCommand="gvDatos_RowCommand" OnSelectedIndexChanged="gvDatos_SelectedIndexChanged" PageSize="15" Width="1000px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IdTramiteClasificado" HeaderText="IdClasif" Visible="False" />
                                </Columns>
                                <EmptyDataTemplate>
