<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmDevuelveAT.aspx.cs" Inherits="Seguridad_wfrmUsuario" StylesheetTheme="Modal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="FondoAplicacion">
        <table width="100%" border="0" cellpadding="false" cellspacing="false">
            <tr>
                <td>
                    <asp:Label ID="lblTituloSistema" runat="server" Font-Bold="True" ForeColor="Navy" Text="ASIGNACION HACIA ARCHIVO TRANSITORIO"></asp:Label>
                </td>
                <td>
        ...
        <div>
            ...
            <table align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width:20%" valign="middle">
                                 <asp:RadioButtonList ID="rblTipoAsignacion" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblTipoAsignacion_SelectedIndexChanged">
                                     <asp:ListItem Value="R">Revisor</asp:ListItem>
                                <asp:ListItem Value="C">Control de Calidad</asp:ListItem>
                                <asp:ListItem Value="V">Responsable de Area</asp:ListItem>
                            </asp:RadioButtonList>
                            &nbsp;</td>
              ...
              alt="No existen datos que correspondan al criterio especificado" />
                            ...
                            <br />
                            <asp:Button ID="btnEnviar" runat="server" OnClick="btnEnviar_Click" Text="Devolver" />
                        </td>
                    </tr>
            </table>
        </div>
