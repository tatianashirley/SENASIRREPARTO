<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmRecursoReclamacion.aspx.cs" Inherits="CertificacionCC_wfrmRecursoReclamacion" %>
                       ...
                       >                                  
                            ...
                            <Columns>                                                                
                              ...
                              <asp:TemplateField HeaderText="Operación" >                                  
                                    <ItemTemplate>
                                        <center>                                                                                
                                            <asp:Button ID="btnLevantarReclamacion" runat="server" Text="Levantar Rec. Reclamación" CausesValidation="false" CommandArgument='<%#((GridViewRow)Container).RowIndex %>' CommandName="cmdLevantar" ToolTip="Levantar Recurso de Reclamación"/>                                                                                    
                                             </center>
                                    </ItemTemplate>
                                </asp:TemplateField>               
                            </Columns>
