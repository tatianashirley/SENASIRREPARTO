...
{
    clsTramiteClasificado ObjTramite = new clsTramiteClasificado();
   ...
   //wcfNovedades.Datos.clsNovedadesDA obj = new wcfNovedades.Datos.clsNovedadesDA();
    ...
    private void CambiarInterfaz()
    {
        ...
        string cOperacion = "Q";
        ddlClasifInicio.DataSource = ObjTramite.ListarClasificacionTramite(iIdConexion, cOperacion);
        ...
        ddlClasifFin.DataSource = ObjTramite.ListarClasificacionTramite(iIdConexion, cOperacion);
        ...
        ddlClasif.DataSource = ObjTramite.ListarClasificacionTramite(iIdConexion, cOperacion);
    ...
    private void Cargar_Grid()
    {
        ...
        gvDatos.DataSource = ObjTramite.ListarTramitesClasificados(iIdConexion, cOperacion, sSessionTrabajo, sSNN, FechaInicio, FechaFin, clasinicio, clasfin, numregistros,
    ...
    protected void btnActualizar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ObjTramite.ReClasificarTramite(iIdConexion, cOperacion, sSessionTrabajo, sSNN, ref sMensajeError, IdTramiteClasificado, IdClasificacionTramite))
            {
