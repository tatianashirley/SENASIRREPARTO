<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmRegistroDocumentosAdministraciones.aspx.cs" Inherits="Notificaciones_wfrmRegistroDocumentoAdministraciones" %>
            ...
            <td colspan="5" align="left">
               <%-- <asp:ImageButton ID="imgAux" runat="server" ImageUrl="~/Imagenes/w.png" />--%>
                ...
                <asp:Label ID="lblRol" runat="server" Font-Size="Small" 
                    ...
                    <tr>
                        <td align="right"><asp:Label ID="Label2" runat="server" Font-Names="Arial" Font-Size="9pt">Matrícula:</asp:Label></td>
                        <td align="left">
                        ...
                        <td align="right"><asp:Label ID="Label3" runat="server" Font-Names="Arial" Font-Size="9pt">Apellido Paterno:</asp:Label></td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right"><asp:Label ID="Label4" runat="server" Font-Names="Arial" Font-Size="9pt">Número Trámite:</asp:Label></td>
                        <td align="left">
...
<%--                            <cc1:FilteredTextBoxExtender ID="txtTramite_FilteredTextBoxExtender1" 
                        ...
                        <td align="right"><asp:Label ID="Label5" runat ="server" Font-Names="Arial" Font-Size="9pt">Apellido Materno:</asp:Label></td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label6" runat="server" Font-Names="Arial" Font-Size="9pt">Documento Identidad:</asp:Label>
                        </td>
                        ...
                        <td align="right"><asp:Label ID="Label7" runat ="server" Font-Names="Arial" Font-Size="9pt">Nombre:</asp:Label></td>
                        <td align="left">
        ...
        <tr>
             ...
             <td align="left"><asp:Label ID="Label9" runat ="server" Font-Names="Arial" Font-Size="9pt">Fecha Nacimiento:</asp:Label></td>
             <td align="left"><asp:Label ID="Label10" runat="server" Font-Names="Arial" Font-Size="9pt">Apellido Paterno:</asp:Label></td>
             <td align="left"><asp:Label ID="Label11" runat="server" Font-Names="Arial" Font-Size="9pt">Apellido Materno:</asp:Label></td>
             <td align="left"><asp:Label ID="Label12" runat="server" Font-Names="Arial" Font-Size="9pt">Nombre(s):</asp:Label></td>
        </tr>
        <tr>
            <%-- <td align="left">
             ...
             <td align="left">
                <asp:TextBox ID="txtFechaNacC" runat="server"  Font-Names="Arial" Font-Size="9pt" Enabled="false"></asp:TextBox>                           
                    ...
                    <tr>
                        <td align="left"><asp:Label ID="Label13" runat ="server" Font-Names="Arial" Font-Size="9pt">Documento Identidad:</asp:Label></td>
                        <td align="left"><asp:Label ID="Label14" runat="server" Font-Names="Arial" Font-Size="9pt">Trámite:</asp:Label></td>
                        <td align="left"><asp:Label ID="Label15" runat="server" Font-Names="Arial" Font-Size="9pt">Matrícula:</asp:Label></td>
                        ...
                        <td align="left"><asp:Label ID="Label16" runat="server" Font-Names="Arial" Font-Size="9pt">Regional:</asp:Label></td>                        
                    </tr>
                    <tr>
                        <td align="left">
                            <asp:TextBox ID="txtCIC" runat="server"  Font-Names="Arial" Font-Size="9pt" Enabled="false"></asp:TextBox>                           
            ...
            <td width="100%" align="left" colspan="6">
                            <asp:GridView ID="gvDatos" runat="server"
                                ...
                                AllowPaging="True"
                                 ...
                                 DataKeyNames="PrimerApellido,SegundoApellido,IdTramite,FechaNacimiento,Funcionario,IdGrupoBeneficio,Direccion">
                                <Columns>
...
<%--AQUI COMIENZA EL CODIGO DE LOS TABS--%>    
       <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1"  OnDemand="true" Width="80%">
        <%--Tab1--%>
    ...
    <table>
           ...
           <%--Tab2--%>
           <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="Registrar Documentos" OnDemandMode="none"  TabIndex="2">  
        <ContentTemplate>              
        <div >      
           ...
           <cc1:TabPanel runat="server" ID="TabPanel5" HeaderText="Notas de Respuesta">
               <ContentTemplate>
                ...
                <tr>
                    <td><asp:Label ID="Label17" Font-Names="Arial" Font-Size="9pt" runat="server" Text="Nro Documento:" CssClass="etiqueta10"/></td>
     ...
     <tr>
            ...
            <tr align="center">
                ...
                <asp:Panel ID="PanelDevolucion" runat="server" CssClass="panelceleste"  HorizontalAlign="Center" Width="500px">
                    <div>
                        <asp:Label ID="Label19" runat="server" Text="Devolver Documento(s)"
                            Font-Size="12pt" Font-Underline="True" Font-Names="Arial" ForeColor="#6699ff"></asp:Label>
                        <table style="width: 80%;">
