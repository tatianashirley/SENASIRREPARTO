<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmDepartamentos.aspx.cs" Inherits="wfrmDepartamentos" StyleSheetTheme="Modal" %>
        ...
        <tr>
            <td align="center" colspan="4" class="auto-style6">
                ...
                <asp:Label ID="lblTituloAUX" runat="server" 
                    Text="Departamentos" CssClass="etiqueta20"></asp:Label>
                            ...
                            <td valign="100%">
                                <asp:GridView ID="gvDatos" runat="server" EnableTheming="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NombreDepartamento" HeaderText="Departamento" ItemStyle-Width="85%">
                                        <ItemStyle Width="85%" />
                                        </asp:BoundField>
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:Panel ID="pnlDatos" runat="server" CssClass="panelprincipal" 
                    ...
                    <div>
                        <asp:Label ID="lblTitulo" runat="server" Text="Departamentos" 
