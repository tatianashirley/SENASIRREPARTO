...
public partial class wfrmDepartamentos : System.Web.UI.Page
{
    int Estado;
    ...
    {
        clsDepartamento admi = new clsDepartamento();
    ...
    protected void ContarRegistros()
    {
        ...
        clsDepartamento tp1 = new clsDepartamento();
        foreach (clsDepartamento tp2 in tp1.ContarDepartamentos())
        {
