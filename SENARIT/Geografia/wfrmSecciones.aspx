<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmSecciones.aspx.cs" Inherits="wfrmSecciones" StyleSheetTheme="Modal" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td align="right" valign="top" class="panelprincipal" width="70%">
                                    <asp:Label ID="Label14" runat="server" CssClass="etiqueta10" style="text-align: left" Text="Departamento :"></asp:Label>
                                    <asp:DropDownList ID="ddlSelDepartamento" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlSelDepartamento_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
        ...
        <tr>
            <td align="center" valign="top" class="auto-style5" >
                                &nbsp;</td>
            <td align="right" valign="top" class="panelprincipal" width="70%">
                                    <asp:Label ID="Label15" runat="server" CssClass="etiqueta10" style="text-align: left" Text="Provincia :"></asp:Label>
                                    <asp:DropDownList ID="ddlSelProvincia" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlSelProvincia_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
            <td align="right" valign="top" class="panelprincipal" width="15%">
                        &nbsp;</td>
                            ...
                            <td valign="100%">
                                <asp:GridView ID="gvDatos" runat="server" EnableTheming="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IdDepartamento" HeaderText="Cod I" ItemStyle-Width="5%">
                                        ...
                                        <asp:BoundField DataField="NombreSeccionMunicipal" HeaderText="Seccion" ItemStyle-Width="75%">
                                        <ItemStyle Width="85%" />
                                        </asp:BoundField>
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:Panel ID="pnlDatos" runat="server" CssClass="panelprincipal" 
                    ...
                    <div>
                        <asp:Label ID="lblTitulo" runat="server" Text="Secciones" 
                            CssClass="etiqueta20"></asp:Label>
                        <table style="width:100%;">
                            <tr>
                                <td align="right" width="30%">
                                    <asp:Label ID="Label13" runat="server" CssClass="etiqueta10" style="text-align: left" Text="Departamento :"></asp:Label>
                                </td>
                                <td align="left" width="70%">
                                    <asp:DropDownList ID="ddlDepartamento" runat="server" Width="250px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" width="30%">
                                    <asp:Label ID="Label16" runat="server" CssClass="etiqueta10" style="text-align: left" Text="Provincia :"></asp:Label>
                                </td>
                                <td align="left" width="70%">
                                    <asp:DropDownList ID="ddlProvincia" runat="server" Width="250px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" width="70%">
                                    ...
                                    <cc1:FilteredTextBoxExtender ID="txtDepartamento_FilteredTextBoxExtender" runat="server" FilterType="Custom, LowercaseLetters, UppercaseLetters" TargetControlID="txtDepartamento" ValidChars=" -">
