<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmProvincias.aspx.cs" Inherits="wfrmProvincias" StyleSheetTheme="Modal" %>
        ...
        <tr>
            <td align="center" colspan="4" class="auto-style6">
                ...
                <asp:Label ID="lblTituloAUX" runat="server" 
                    Text="Provincias" CssClass="etiqueta20"></asp:Label>
                            ...
                            <td valign="100%">
                                <asp:GridView ID="gvDatos" runat="server" EnableTheming="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IdDepartamento" HeaderText="Cod Id Dep" ItemStyle-Width="5%">
                                        <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="IdProvincia" HeaderText="Cod Id Prov" ItemStyle-Width="5%">
                                        <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="NombreProvincia" HeaderText="Provincia" ItemStyle-Width="80%">
                                        <ItemStyle Width="85%" />
                                        </asp:BoundField>
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:Panel ID="pnlDatos" runat="server" CssClass="panelprincipal" 
                    ...
                    <div>
                        <asp:Label ID="lblTitulo" runat="server" Text="Provincias" 
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td align="left" width="70%">
                                    <asp:DropDownList ID="ddlDepartamento" runat="server" Width="250px" OnSelectedIndexChanged="ddlDepartamento_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                    <asp:Label ID="Label12" runat="server" CssClass="etiqueta10" style="text-align: left" Text="Provincia :"></asp:Label>
                                </td>
                                <td align="left">
                                    <asp:TextBox ID="txtProvincia" runat="server" CssClass="texto10_Upper" MaxLength="50" Width="250px"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="txtProvincia_FilteredTextBoxExtender" runat="server" FilterType="Custom, LowercaseLetters, UppercaseLetters" TargetControlID="txtProvincia" ValidChars=" -">
