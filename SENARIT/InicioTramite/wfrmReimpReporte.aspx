<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmReimpReporte.aspx.cs" Inherits="InicioTramite_wfrmReimpReporte" %>
                ...
                <td align="center">
                    <asp:GridView ID="gvBusquedaTramiteCC" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Form01">
                                <ItemTemplate>
                                    <center>
                            ...
                            <asp:TemplateField HeaderText="Form02">
                                <ItemTemplate>
                                    <center>
                                        <asp:ImageButton ID="imgReporte2" runat="server" CausesValidation="false" CommandArgument='<%#((GridViewRow)Container).RowIndex %>' CommandName="cmdReporte2" ImageUrl="~/imagenes/Menu/Impresora.png" />
                                    </center>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Form03">
                                <ItemTemplate>
                                    <center>
                                        <asp:ImageButton ID="imgReporte3" runat="server" CausesValidation="false" CommandArgument='<%#((GridViewRow)Container).RowIndex %>' CommandName="cmdReporte3" ImageUrl="~/imagenes/Menu/Impresora.png" />
                                    </center>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
