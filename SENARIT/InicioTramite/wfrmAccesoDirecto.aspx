<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmAccesoDirecto.aspx.cs" Inherits="InicioTramite_wfrmAccesoDirecto" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:Panel ID="pnlCabeceraMalla" runat="server">
        <table width="100%" border="0" cellpadding="false" cellspacing="false">
            ...
            <tr>
                <td align="right">
                    <label class="etiqueta10">Trámite</label>
                </td>
                <td align="left">
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="gvBusquedaTramiteCC" runat="server"
                        ...
                        DataKeyNames="IdTramite,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido,FechaNacimiento,CUA,Matricula,NumeroDocumento,ComplementoSEGIP,TramiteObservaciones">
