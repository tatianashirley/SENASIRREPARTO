<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmRegistroTramiteFFAA.aspx.cs" Inherits="wfrmRegistroTramiteFFAA" StylesheetTheme="Modal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlCabeceraMalla" runat="server" CssClass="panelprincipal">
        <table width="100%" border="0" cellpadding="false" cellspacing="false">
            <tr>
                <td align="right" width="25%">
                    <label class="etiqueta10">Primer Apellido:</label></td>
                <td align="left" width="10%">
                    <asp:TextBox ID="txtPrimerApellido" runat="server" onkeyup="this.value=this.value.toUpperCase()" autofocus="autofocus" Width="200px" MaxLength="30" onKeyPress="return disableEnterKey(event)"></asp:TextBox>
