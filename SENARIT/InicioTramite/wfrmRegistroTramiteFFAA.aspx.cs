...
public partial class wfrmRegistroTramiteFFAA : System.Web.UI.Page
{
    #region inicio
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblSubTitulo.Text = "Buscar Persona FF.AA.";
    ...
    protected void gvPersona_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "cmdTramite")
        {
            ...
            if (queryStringPrestacionHabilitada == "FFAA")
            {
                sPaginaDestino = "wfrmCompletarDatosFFAA.aspx";
            }
            else
            {
                sPaginaDestino = "wfrmCompletarDatos.aspx";
            }
            contentUrl = string.Format(sPaginaDestino + "?NUP={0}&Tipo={1}&MAT={2}&PNO={3}&SNO={4}&PAP={5}&SAP={6}&ACA={7}&FNA={8}&CUA={9}&NDO={10}&CSE={11}&TAB={12}",
            ...
            encriptFechaNacimiento, encriptCUA, encriptNumeroDocumento, encriptComplemento, encriptStringTabla);
    ...
    protected void gvPersona_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (btnTramite != null && btnBloqueo != null)
            {
    ...
    private void BuscarPersona()
    {
        ...
        try
        {
            ...
            {
                dtListaPersonas = clsPersona.BuscarPorIdentificador(iIdConexion, cOperacion, "FFAA", "CI", sNumeroDocumento, ref sMensajeError);
            }
            else
            {
                dtListaPersonas = clsPersona.BuscarPorAvanzada(iIdConexion, cOperacion, "FFAA", sPrimerApellido, sSegundoApellido, sPrimerNombre, sSegundoNombre, sNumeroDocumento, sFechaNacimiento, sPrecision, ref sMensajeError);
            }
