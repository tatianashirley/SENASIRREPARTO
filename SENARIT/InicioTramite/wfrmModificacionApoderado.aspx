<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmModificacionApoderado.aspx.cs" Inherits="InicioTramite_wfrmModificacionApoderado" %>
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="gvBusquedaTramiteCC" runat="server"
                        ...
                        DataKeyNames="IdTramite,TipoTramite,NUP,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido,ApellidoCasada,FechaNacimiento,FechaFallecimiento,CUA,Matricula,NumeroDocumento,ComplementoSEGIP">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CUA" HeaderText="NUA" Visible="false" />
