<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmBuscarAfiliadoAP.aspx.cs" Inherits="InicioTramite_wfrmBuscarAfiliadoAP" %>
        ...
        <table width="100%" border="0" cellpadding="false" cellspacing="false">
            <tr>
                ...
                <td align="left" width="10%">
                    <asp:TextBox ID="txtCuaBuscar" runat="server" MaxLength="30" Width="200px" autofocus="autofocus" onKeyPress="return disableEnterKey(event)"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="txtPaternoBuscar" runat="server" MaxLength="50" onkeyup="this.value=this.value.toUpperCase()" Width="200px" onKeyPress="return disableEnterKey(event)"></asp:TextBox>
            ...
            <tr>
                <td colspan="4" align="center">
                    ...
                    <asp:Button runat="server" ID="imgbtnNuevo" OnClick="imgbtnNuevo_Click" Text="Nuevo" Width="200px" />
                </td>
            </tr>
        </table>
    </asp:Panel>
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="gvBusquedaTramiteCC" runat="server"
                        ...
                        DataKeyNames="NUA,PRIMER_NOMBRE,SEGUNDO_NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,APELLIDO_CONYUGUE,FEC_NACIMIENTO,NUM_IDENTIFICACION">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:BoundField DataField="TipoAFP" HeaderText="Tipo AFP" />
                            <asp:BoundField DataField="NUA" HeaderText="NUA" />
                            <asp:BoundField DataField="NUM_IDENTIFICACION" HeaderText="Número Documento" />
                            ...
                            <asp:BoundField DataField="APELLIDO_CONYUGUE" HeaderText="Apellido Casada" Visible="false" />
                            <asp:BoundField DataField="FEC_NACIMIENTO" HeaderText="Fecha Nacimiento" DataFormatString="{0:d}" />
                            <asp:TemplateField HeaderText="Modificar">
                                <ItemTemplate>
                                    <center>
                                        <asp:ImageButton ID="imgTramite" runat="server" CausesValidation="false" CommandArgument='<%#((GridViewRow)Container).RowIndex %>' CommandName="cmdTramite" ImageUrl="~/imagenes/nueva3/siguiente32.png" ToolTip="Modificar" />
