<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmRepCtrlCites.aspx.cs" Inherits="EnvioAPS_wfrmRepCtrlCites" %>
...
<div style="vertical-align: top; left: auto; height: auto; overflow: auto; width: 1200px;">
    <asp:Label ID="Label1" runat="server" Text="REPORTE CONTROL DE CITES" CssClass="etiqueta20" ></asp:Label>
