<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmControlDeEnvios.aspx.cs" Inherits="EnvioAPS_wfrmControlDeEnvios" %>
        ...
        <tr>
            <td align="center">
                ...
                <asp:Label ID="lblTituloAUX" runat="server"
                    Text="CONTROL DE ENVIOS" CssClass="etiqueta20"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <tr>
                    <td colspan="10" align="left">
                        <asp:Label ID="Label4" runat="server" Text="Bandeja de Envios" CssClass="etiqueta10" Font-Bold="True"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:GridView ID="gvEnvios" runat="server" AutoGenerateColumns="False" CellPadding="4" 
                                ...
                                <asp:TemplateField ItemStyle-Width="40px">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgCERRAR" runat="server" 
                                            ImageUrl="~/Imagenes/24CD_Disc_2_Certificate.gif"
                                            CommandName="CERRAR"
                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                            ToolTip="Click para CERRAR el Envio"
                                            onclientclick="return confirm('Esta seguro de CERRAR este ENVIO ?');" />
                                    </ItemTemplate>
                            ...
                            <EmptyDataTemplate>
                                ...
                                <br/>No existen Envios en proceso de CIERRE
                                <br/><br/>
                                </div>
                            </EmptyDataTemplate>
                        </asp:GridView>
                        <asp:GridView ID="gvDetalleEnvioAPS" runat="server" CellPadding="4" ForeColor="#333333" 
                            ...
                            <Columns>
                                ...
                                <asp:CheckBoxField DataField="RegistroActivo" HeaderText="RegistroActivo" Visible="false" />
                                <asp:TemplateField HeaderText="Actualizacion" SortExpression="CodigoActualizacion">
                                    <ItemTemplate>
            ...
            <td >
                ...
                <tr>
                    <td colspan="4" align="left">
                        <asp:Label ID="Label5" runat="server" Text="Envios APS" CssClass="etiqueta10" Font-Bold="True"></asp:Label>
                    </td>
                </tr>
                <tr>
