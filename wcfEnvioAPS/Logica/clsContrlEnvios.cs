...
namespace wcfEnvioAPS.Logica
{
    public class clsContrlEnvios : clsControlEnviosBE
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Boolean TramitesEnvioDeMediosDetalle()
        {
            objContrlEnviosDA.iIdConexion = iIdConexion;
            objContrlEnviosDA.sNumeroEnvio = sNumeroEnvio;
            objContrlEnviosDA.iIdEntidad = iIdEntidad;
            Boolean AnsOK = objContrlEnviosDA.TramitesEnvioDeMediosDetalleDA();
            DSet = objContrlEnviosDA.DSet;
            sMensajeError = objContrlEnviosDA.sMensajeError;
            return (AnsOK);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Boolean RemisionDeTramites()
        {
            objContrlEnviosDA.iIdConexion = iIdConexion;
            objContrlEnviosDA.sNumeroEnvio = sNumeroEnvio;
            objContrlEnviosDA.iIdEntidad = iIdEntidad;
            Boolean AnsOK = objContrlEnviosDA.RemisionDeTramitesDA();
            sMensajeError = objContrlEnviosDA.sMensajeError;
            return (AnsOK);
        }
        /// <summary>
        ...
        /// <summary>
        /// RemisionEnviosAPS_ArchivoCentral
        /// </summary>
        /// <returns></returns>
        public DataTable RemisionEnviosAPS_ArchivoCentral(Int64 iIdConexion, string sNumeroEnvio, int iIdEntidad)
        {
            return (objContrlEnviosDA.RemisionEnviosAPS_ArchivoCentralDA(iIdConexion, sNumeroEnvio, iIdEntidad));
        }
        #endregion
    }
}