...
namespace wcfWorkFlowN.Datos
{
    ...
    public class clsHisRestriccionDA : clsWorkflowBaseDA
    {
        ...
        {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_HisRestriccion", "U");
            if (!ObjSPExec.p_bEstadoOK)
            {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            }
        ...
        {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_HisRestriccion", "V");
            if (!ObjSPExec.p_bEstadoOK)
            {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            }
        ...
        public bool ObtieneHisRestricciones()
        {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_HisRestriccion", "Q");
            if (!ObjSPExec.p_bEstadoOK)
            {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            }
