...
namespace wcfWorkFlowN.Datos
{
    ...
    public class clsHisGrupoRestriccionDetDA : clsWorkflowBaseDA
    {
        ...
        {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_HisGrupoRestriccionDet", "U");
            if (!ObjSPExec.p_bEstadoOK)
            {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            }
        ...
        {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_HisGrupoRestriccionDet", "V");
            if (!ObjSPExec.p_bEstadoOK)
            {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            }
        ...
        {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_HisGrupoRestriccionDet", "Q");
            if (!ObjSPExec.p_bEstadoOK)
            {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            }
