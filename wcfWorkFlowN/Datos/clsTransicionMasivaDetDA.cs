...
namespace wcfWorkFlowN.Datos {
    ...
    public class clsTransicionMasivaDetDA : clsWorkflowBaseDA {
        ...
        public bool ObtieneUsuarios() {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_InstanciaNodo", "G");
            if (!ObjSPExec.p_bEstadoOK) {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            } else {
                bool bAsignacionOK = true;
        ...
        /// <summary>
        /// Obitiene los usuarios disponibles para asignación de expedientes desde archivo
        /// </summary>
        /// <returns></returns>
        public bool ObtieneUsuariosConsulta() {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_InstanciaNodo", "V");
            if (!ObjSPExec.p_bEstadoOK) {
                sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
            } else {
                ...
                if (bAsignacionOK) {
                    if (!ObjSPExec.EjecutarProcedimientoQry()) {
                        ...
                        DataSet DSetINodo = new DataSet();
                        DSetINodo = ObjSPExec.p_DataSetResultado.Copy() ;
                        ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_HisFlujoNodo", "W");
                        if (!ObjSPExec.p_bEstadoOK) {
                            sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
                        } else {
                            bAsignacionOK = true;
                            ...
                            if (bAsignacionOK) {
                                if (!ObjSPExec.EjecutarProcedimientoQry()) {
                                    ...
                                    DataSet DSetHFNodo = new DataSet();
                                    DSetHFNodo = ObjSPExec.p_DataSetResultado.Copy();
                                    ObjSPExec = new ClassSPExec(iIdConexion, "Workflow.PR_HisTipoTramiteRolUsuario", "T");
                                    if (!ObjSPExec.p_bEstadoOK) {
                                        sMensajeError = ObjSPExec.ObtenerPilaMensajesError();
                                    } else {
                                        bAsignacionOK = true;
                                        ...
                                        bAsignacionOK = bAsignacionOK && ObjSPExec.AsignarValorParametro("@s_iSesionTrabajo", null);
                                        bAsignacionOK = bAsignacionOK && ObjSPExec.AsignarValorParametro("@s_sSSN", null);
                                        bAsignacionOK = bAsignacionOK && ObjSPExec.AsignarValorParametro("@i_iIdRol", int.Parse(DSetHFNodo.Tables[0].Rows[0]["IdRol"].ToString()));
                                        bAsignacionOK = bAsignacionOK && ObjSPExec.AsignarValorParametro("@i_iIdUsuario", int.Parse(DSetHFNodo.Tables[0].Rows[0]["IdUsuario"].ToString()));
                                        bAsignacionOK = bAsignacionOK && ObjSPExec.AsignarValorParametro("@i_iIdOficina", int.Parse(DSetHFNodo.Tables[0].Rows[0]["IdOficina"].ToString()));
                                        bAsignacionOK = bAsignacionOK && ObjSPExec.AsignarValorParametro("@i_iIdArea", int.Parse(DSetHFNodo.Tables[0].Rows[0]["IdArea"].ToString()));
