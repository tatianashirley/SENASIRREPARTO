...
{
    public class clsProgramacionDA
    {
        string sMensajeError = "";
        public bool PlazoProgramacion(int iIdConexion, string cOperacion, ref string sMensajeError, ref DataSet DSetTmp)
        {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "CertificacionCC.PR_PlazoProgramacion", cOperacion);
        ...
        public bool EstructuraProgramacion(int iIdConexion,string cOperacion, ref string sMensajeError, ref DataSet DSetTmp)
        {
        ...
        public bool ProgramacionResponsable(int iIdConexion,string cOperacion,int iIdEstructura, ref string sMensajeError,ref DataSet DSetTmp)
        {
            ClassSPExec ObjSPExec = new ClassSPExec(iIdConexion, "CertificacionCC.PR_ProgramacionEstructura", cOperacion);
        ...
        public bool ProgramacionAdiciona(int iIdConexion,string cOperacion,int iIdEstructuraProgramacion,int iIdPlazoProgramacion,int iIdResponsable,string sFechaInicio,string sFechaFinal, ref string sMensajeError,ref int iIdProgramacion)
        {
            ...
            else
            {
                ...
                if (bAsignacionOK)
                {
                    ...
                    {
                        ObjSPExec.ObtenerValorParametro("@o_iIdProgramacion", ref iIdProgramacion);
                        iIdProgramacion = Convert.ToInt32(iIdProgramacion);
                    }
