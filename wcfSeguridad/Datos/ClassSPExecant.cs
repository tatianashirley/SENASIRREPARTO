                ...
                try {
                    foreach (System.Data.SqlClient.SqlParameter prm in w_ComandoSQL.Parameters) {
                        if (prm.Direction.ToString().ToLower() != "returnvalue") {
                            ...
                            else if (prm.SqlDbType.ToString().ToLower() == "bigint" || prm.SqlDbType.ToString().ToLower() == "int" || prm.SqlDbType.ToString().ToLower() == "smallint" || prm.SqlDbType.ToString().ToLower() == "tinyint" || prm.SqlDbType.ToString().ToLower() == "money" || prm.SqlDbType.ToString().ToLower() == "float" || prm.SqlDbType.ToString().ToLower() == "decimal")
                            {
                                if (!Convert.IsDBNull(prm.Value) && prm.Value != null) {
